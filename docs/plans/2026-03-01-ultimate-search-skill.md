...
- Create: `UltimateSearch/.env.example`
- Create: `UltimateSearch/.gitignore`
...
- Create: `UltimateSearch/docker-compose.yml`
...
- Create: `UltimateSearch/scripts/setup.sh`
...
- Create: `UltimateSearch/scripts/grok-search.sh`
...
- Create: `UltimateSearch/scripts/tavily-search.sh`
...
- Create: `UltimateSearch/scripts/web-fetch.sh`
...
- Create: `UltimateSearch/scripts/web-map.sh`
...
- Create: `UltimateSearch/scripts/dual-search.sh`
...
- Create: `UltimateSearch/SKILL.md`
...
- Create: `UltimateSearch/README.md`
...
- Create: `UltimateSearch/docs/architecture.md`
...
ln -s ~/UltimateSearch/SKILL.md ~/.openclaw/skills/ultimate-search/SKILL.md

# 将脚本目录加入 PATH
echo 'export PATH="$HOME/UltimateSearch/scripts:$PATH"' >> ~/.bashrc
source ~/.bashrc
```
